...
Prog1_3Simulation::Prog1_3Simulation()
...
Prog1_3Simulation::~Prog1_3Simulation() = default;


void Prog1_3Simulation::resize(int w, int h)
{
	this->width = w;
	this->height = h;
...
void Prog1_3Simulation::mouseEvent(QMouseEvent * e)
{
	auto type = e->type();
	auto pos = e->position();
...
Eigen::VectorXd Prog1_3Simulation::step()
{
	this->u = solver.solve(this->u);
	return this->u;
}

int Prog1_3Simulation::getIndex(int i, int j) const
{
	// von 2d index auf 1d index
	return i * grid_size + j;
}

void Prog1_3Simulation::buildSystemMatrix()
{
...
void Prog1_3Simulation::setInitialConditions()
{
...
Eigen::Vector3d Prog1_3Simulation::calculateNormal(int i, int j) const
{
...
void Prog1_3Simulation::setTemperatureScale(double tempScaleParam)
{
